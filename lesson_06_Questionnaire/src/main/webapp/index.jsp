...
<body>
	...
	<script type="text/javascript">
			...
			option = {
			    backgroundColor: '#000',
			    globe: {
			        baseTexture: '${pageContext.request.contextPath}/static/img/GL/1.jpg',
			        heightTexture: '${pageContext.request.contextPath}/static/img/GL/2.jpg',
			
			        displacementScale: 0.1,
			
			        shading: 'lambert',
			
			        environment: '${pageContext.request.contextPath}/static/img/GL/3.jpg',
			        ...
			        layers: [{
			            type: 'blend',
			            blendTo: 'emission',
			            texture: '${pageContext.request.contextPath}/static/img/GL/4.jpg'
			        }, {
			            type: 'overlay',
			            texture: '${pageContext.request.contextPath}/static/img/GL/5.png',
			            shading: 'lambert',
			            distance: 5
			        }]
			    },
		...
		<div style="position: absolute;left:0; top: 25%; width: 100%; z-index:9998;margin-top: 50px;">
			<h3 style="margin-top: 0px;margin-bottom: 3%;"><span style="color:#fff;">零界</span>问卷</h3>
			
			<h1 style="color:white-space;font-size: 48px;">帮助你了解地球上每一个角落的想法</h1>
